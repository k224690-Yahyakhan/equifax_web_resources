...
(() => {
    var e = {
                ...
                class b extends r.EventEmitter {
                    ...
                    _showConsentExperience(e, t, n) {
                        ...
                        return i.__awaiter(this, void 0, void 0, (function*() {
                            ...
                            const d = yield this.retrieveConsent();
                            return yield this.renderExperience(t, s.ExperienceType.Consent, e, n), this.emit(S.default.SHOW_CONSENT_EXPERIENCE_EVENT, d, n), d
                        }))
                    }
                    ...
                    renderExperience(e, t, n, r) {
                        return i.__awaiter(this, void 0, void 0, (function*() {
                            ...
                            return this.renderExperienceTrigger(i, e, t, n, r), Promise.resolve()
                        }))
                    }
                    renderExperienceTrigger(e, t, n, i, r) {
                        const o = {
                            experienceType: t,
                            params: i,
                            options: r
                        };
                        this.triggerExperience(n, S.default.RENDER_EXPERIENCE_EVENT, e, o)
                    }
                    ...
                    trigger(e, t, n) {
                        return i.__awaiter(this, void 0, void 0, (function*() {
                            ...
                            e ? yield this.setProfile(O.ProfileSection.TRIGGERS, {
                                functionArguments: e
                            }): yield this.setProfile(O.ProfileSection.TRIGGERS, {
                                functionArguments: void 0
            ...
            7893: (e, t, n) => {
                ...
                var s;
                ! function(e) {
                    e.CONSENT_PURPOSES = "consent.purposes", e.CONSENT_NEEDS_CONSENT = "consent.needsConsent", e.CONSENT_COLLECTED_AT = "consent.collectedAt", e.IDENTITIES = "identities", e.USER = "user", e.SUBSCRIPTION = "subscription", e.METADATA = "metadata", e.PAGE = "page", e.TRIGGERS = "triggers"
                ...
                t.RuleEngine = class {
                    ...
                    constructor(e, t = []) {
                        this._triggerQueue = new Set, this._isStarted = !1, this._isProcessing = !1, this._processingPromise = null, this._results = new Map, this.processQueue = () => i.__awaiter(this, void 0, void 0, (function*() {
                            ...
                            let c = e;
                            if (e === o.RuleTrigger.ON_FUNCTION) {
                                const t = yield this.ketch.getProfileManager().getValueFromKey("triggers.functionArguments");
                                t && "string" == typeof t && (c = `${e}|${t}`, a.debug("constructed full trigger key from functionArguments", {
                                    trigger: e,
                                    functionArguments: t,
                                    ruleKey: c
                                }))
                            }
                            const l = (null === (s = null === (i = yield this.ketch.getFullConfig()) || void 0 === i ? void 0 : i.rules) || void 0 === s ? void 0 : s[c]) || [];
                            ...
                            for (const i of l) {
                                ...
                                if (u.ruleMap.set(i.code, r), r) return i.action.options && i.action.options.consentSourceOverride === o.ConsentSource.RecollectAfterDate && this.ketch.setConsentSourceOverride(o.ConsentSource.RecollectAfterDate), a.debug("executing rule for trigger", e, {
                                    rule: i
                                }), u.didShowExperience = yield this.executeAction(i.action, t, n), u
                            }
                            return u
                        })), this.addResult = (e, t) => {
                            var n;
                            ...
                            switch (l.experiences.content[s] = u.content[s], l.experiences.content.display = s, l.experiences.content.static = u.content.static, l.experiences.layout[s] = u.layout[s], l.experiences.layout.entitlementInfo = u.layout.entitlementInfo, s === o.DisplayExperienceType.Preference ? (l.experiences.autoInitiated.content = Object.assign(Object.assign({}, l.experiences.autoInitiated.content), {
                                ...
                                case "showConsent":
                                    ...
                                    break;
                                default:
                                    const n = s === o.DisplayExperienceType.Preference ? o.ExperienceType.Preference : o.ExperienceType.Consent;
                                    this.ketch.renderExperience(s, n, t, e.options)
                            }
                            return !0
            ...
            8347: (e, t, n) => {
                ...
                t.default = function() {
                    ...
                    return i.__awaiter(this, void 0, void 0, (function*() {
                        ...
                        window.semaphore.push = g.push.bind(g), window.semaphore.ketch = _, window.semaphore.loaded = !0;
